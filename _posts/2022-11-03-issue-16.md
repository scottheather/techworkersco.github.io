...
* Some states have single party consent laws that allow you to legally record audio. You are acting as the single consenting party. If you can, record your meetings so you have evidence if you need it in the future for wrongful termination. If you’re not in a single party consent state, get creative. Have a colleague in one of these states hop on the phone to help you record and document any layoff conversations. [See further considerations here.](#### Additional Thoughts on Taking Recordings, from a recent (successful but anonymous) NLRB case)
...
#### Additional Thoughts on Taking Recordings, from a recent (successful but anonymous) NLRB case
* The current NLRB Administration has shown support for widespread [Weingarten Rights](https://www.natlawreview.com/article/will-nonunion-employees-have-weingarten-rights-workplace-soon).
* Recording conversations has murky legal history in the United States, which is further exacerbated by labor/employment law that does not always cover instances of 2022 zoom-era digital meetings. In situations where cases move towards legal action, a legal representative can advise the individual regarding the _use_ of said recordings. The content of a private conversation is not inherently confidential. Publication of said private conversation would be a big risk.
* Your employer is willing to break the law in ther pursuit of firing you. This is not an advocacy of violating laws, but rather -- a reminder that recordings are used in defense of illegal actions taken against you.
* In the absence of recordings, notes and recollections of meetings can be used as substitute for recordings. Once again, The content of a private converstaion is not inherently confidential.
* In a recent case, the NLRB offered the following reasoning for accepting recordings:
    - These recordings were made when the subject had clear understanding that this meeting was to be a disciplinary meeting
    - The recordings were made in environments without a clear expectation of privacy. Participants of meetings were calling from semi-private spaces (ie -- home offices) where the presence of off-screen attendees was unknown. Zoom/teleconference meetings with a large number of participants are not reasonably private.
    - The cases had legal merit with or without recordings, recordings served as a primary record on one piece of a larger event 
* If you live in a two-party consent state, inform the other party that you will be recording this (disciplinary) conversation and that their continuance of this conversation implies consent. Inform them that, alternatively, they can choose to discipline you in writing.
